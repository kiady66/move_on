        ...
        RecomendCityCard(
          ...
          press: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DetailsScreen(image: "https://cdn.getyourguide.com/img/location/5ffeb392eb81e.jpeg/68.jpg"),
              ),
            );
          },
        ),
        RecomendCityCard(
          ...
          press: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DetailsScreen(image: "https://www.bing.com/th?id=Ade945c621ab51a1ac17eb981bd3584ca&w=188&h=132&c=7&o=6&dpr=1.25&pid=SANGAM"),
              ),
            );
          },
        ),
        RecomendCityCard(
          ...
          press: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DetailsScreen(image: "https://i.pinimg.com/originals/d2/52/46/d2524646bbf61c45a0dcbb0f4f4a7223.jpg"),
              ),
            );
          },
        ),
        RecomendCityCard(
          ...
          press: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DetailsScreen(image: "https://th.bing.com/th/id/R.a133fbe5869d8efc322b3bb1222f369a?rik=%2fdxN6q%2b0yE67Ew&riu=http%3a%2f%2f1.bp.blogspot.com%2f-6HXmBjf6KvQ%2fU7UYXGdwktI%2fAAAAAAAAGMA%2fst1tAoHmqOw%2fs1600%2fDSCN5512.JPG&ehk=ofJbAUKVuAi1V81NtxEJ3r64VKhQrzLJYIgRoN87lJ0%3d&risl=&pid=ImgRaw&r=0"),
              ),
            );
          },
        ),
        RecomendCityCard(
          ...
          press: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DetailsScreen(image: "https://static.actu.fr/uploads/2020/09/20200521-175936-960x640.jpg"),
              ),
            );
          },
        ),
